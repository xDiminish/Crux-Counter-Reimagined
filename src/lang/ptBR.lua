...
function M.Setup()
    ...
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_ENABLE", "Ativar Flash na Advertência de Expiração")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_ENABLE_DESC", "Ativa a animação flash na advertência.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_START_THRESHOLD", "Limiar de Início do Flash")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_START_THRESHOLD_DESC", "Limiar (segundos antes da expiração) em que a animação inicia, dentro do limite de advertência.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_SPEED", "Intensidade do Flash")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_SPEED_DESC", "Velocidade da animação flash.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RUNE_COLOR_1", "Cor inicial da runa")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RUNE_COLOR_1_DESC", "Cor inicial das runas durante a animação.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RUNE_COLOR_2", "Cor final da runa")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RUNE_COLOR_2_DESC", "Cor final das runas durante a animação.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_BACKGROUND_COLOR_1", "Cor inicial do fundo")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_BACKGROUND_COLOR_1_DESC", "Cor inicial do fundo durante a animação.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_BACKGROUND_COLOR_2", "Cor final do fundo")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_BACKGROUND_COLOR_2_DESC", "Cor final do fundo durante a animação.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_NUMBER_COLOR_1", "Cor inicial da aura")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_NUMBER_COLOR_1_DESC", "Cor inicial da aura durante a animação.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_NUMBER_COLOR_2", "Cor final da aura")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_NUMBER_COLOR_2_DESC", "Cor final da aura durante a animação.")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RESET_COLORS", "Redefinir todas as cores do Flash")
    ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RESET_COLORS_DESC", "Restaura as cores do flash para os valores padrão.")
end

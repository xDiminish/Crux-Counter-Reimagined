...
function M.Setup()
	...
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_ENABLE", "Włącz miganie przy ostrzeżeniu o wygaśnięciu")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_ENABLE_DESC", "Aktywuje animację flash przy ostrzeżeniu.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_START_THRESHOLD", "Próg rozpoczęcia migań")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_START_THRESHOLD_DESC", "Próg (sekundy przed wygaśnięciem), kiedy animacja się rozpoczyna, w ramach progu ostrzeżenia.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_SPEED", "Intensywność migań")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_SPEED_DESC", "Prędkość animacji flash.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RUNE_COLOR_1", "Początkowy kolor runy")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RUNE_COLOR_1_DESC", "Początkowy kolor run podczas animacji.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RUNE_COLOR_2", "Końcowy kolor runy")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RUNE_COLOR_2_DESC", "Końcowy kolor run podczas animacji.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_BACKGROUND_COLOR_1", "Początkowy kolor tła")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_BACKGROUND_COLOR_1_DESC", "Początkowy kolor tła podczas animacji.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_BACKGROUND_COLOR_2", "Końcowy kolor tła")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_BACKGROUND_COLOR_2_DESC", "Końcowy kolor tła podczas animacji.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_NUMBER_COLOR_1", "Początkowy kolor aury")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_NUMBER_COLOR_1_DESC", "Początkowy kolor aury podczas animacji.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_NUMBER_COLOR_2", "Końcowy kolor aury")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_NUMBER_COLOR_2_DESC", "Końcowy kolor aury podczas animacji.")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RESET_COLORS", "Zresetuj wszystkie kolory flash")
	ZO_CreateStringId("CRUX_COUNTER_SETTINGS_STYLE_WARN_FLASH_RESET_COLORS_DESC", "Przywraca kolory flash do domyślnych.")
end
